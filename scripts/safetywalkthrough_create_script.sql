...
INSERT INTO `question` (questionId,questionText,shortDesc,ratingOption1,ratingOption2,ratingOption3,ratingOption4) VALUES (2,'Count signs with positive behavioral expectations of students.','Positive Signs','None','1 or more',NULL,NULL);
...
INSERT INTO `question` (questionId,questionText,shortDesc,ratingOption1,ratingOption2,ratingOption3,ratingOption4) VALUES (12,'Count evidence of substance use. Look for bottles, cans, or paraphernalia that once held alcohol, prescriptions, or illicit drugs.','Substance Use','None','1 or more',NULL,NULL);
